...
export const getUploadTokenHttp = (param) => Service(`/staticData/api/v1/cloud/mgr/getUploadToken`, 'post', param); //获取token
...
export const sendInvitationHttp = (param) => Service(`/account/api/v1/account/etr/sendInvitation`, 'post', param); 													//发送企业邀请
export const sendInvitationHttpAgain = (id, param) => Service(`/account/api/v1/account/etr/${id}/resendInvitation `, 'put', param); 				//重新发送企业邀请
...
export const deleteEmployeeHttp = (id, type) => Service(`/account/api/v1/account/etr/${id}/delStaff/${type}`, 'get'); 											//删除员工信息
...
export const updateRoleHttp = (id, param) => Service(`/account/api/v1/account/etr/${id}/updateRole`, 'put', param); 												//编辑用户角色信息
export const getAuditTaskHttp = (type, query) => Service(`/car/api/v1/apply/getAuditTask/${type}${getUrlConcat(query)}`, 'get'); 						//查询待审批任务
export const disposeAuditTaskHttp = (id, param) => Service(`/car/api/v1/apply/${id}/auditTask`, 'put', param); 															//审批任务
